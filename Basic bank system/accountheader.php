    ...
    <body class="d-flex flex-column" style="z-index: 100;">
            ...
            <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
                ...
                <div class='collapse navbar-collapse' id='mynavbar'>
                    <ul class='nav navbar-nav navbar-dark ml-auto'>
                        <li> <a class="nav-link" href="/bank/home.php"> Home </a> </li>
                        <li> <a class="nav-link" href="/bank/about.php"> About Us </a> </li>
                        <li> <a class="nav-link" href="/bank/dashboard.php"> Dashboard </a> </li>
                        <li> <a class="nav-link" href="/bank/careers.php"> Careers </a> </li>
                        <li> <a class="nav-link" href="/bank/contact.php"> Contact Us </a> </li>
                    </ul>
                </div>
            </nav>
        </header>
        ...
        <div class="row">
            ...
            <div class="sidebar-sticky pt-3">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/bank/dashboard.php">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/bank/beneficiaries.php">
                    <span><img style="padding-right: 5px;" src="images/users.svg"></span>
                    Manage Beneficiaries
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/bank/summary.php">
